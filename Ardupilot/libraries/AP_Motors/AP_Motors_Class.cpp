...
/*
Sthiti added this code to change and switch directions, not sure if it will work
*/
// void AP_Motors::change_motor_dir(uint8_t motor_num)
// {
//     // Get motor function from SRV_Channels
//     SRV_Channel::Function function = SRV_Channels::get_motor_function(motor_num);

//     // Set direction pins LOW (assuming motor driver uses two channels per motor)
//     SRV_Channels::set_output_pwm_chan(function, 0);        // Set PWM to 0% (fully off)
//    // SRV_Channels::set_output_pwm_chan(function + 1, 0);    // Also set the complementary channel to 0%
// }
