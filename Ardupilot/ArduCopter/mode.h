...
public:
    ...
    enum class Number : uint8_t {
        ...
        DRIVE =        29, // mode to transform into ROVER, ROCK EDLLLLLL Sthiti
        MORPH =        31, // mode to morph, Neel
    ...
    Mode::Number get_previous_mode(Mode::Number curr_mode); 
...
public:
    ...
    bool init(bool ignore_checks) override; //Check this one out URGENT: Sthitit
    virtual void run() override;
...
#if MODE_MORPH_ENABLED
class ModeMorph: public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::MORPH; }
...
protected:
    ...
    const char *name4() const override { return "MORP"; }
};
#endif
